...
import {
  ACCOUNTING_COMPANY_PARTITIONED_TABLES,
  ACCOUNTING_TENANT_SCOPED_TABLES,
  ACCOUNTING_VERSION_EXEMPT_TABLES,
  accountingSchema,
} from './accounting.js';
import {
  BILLING_COMPANY_PARTITIONED_TABLES,
  BILLING_TENANT_SCOPED_TABLES,
  BILLING_VERSION_EXEMPT_TABLES,
  billingSchema,
} from './billing.js';
import {

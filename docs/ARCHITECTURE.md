...
page and every request it makes is still refused by the server. Nothing about the system's safety
may be argued from a hidden control or an unreachable route.
